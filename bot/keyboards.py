...
class Keyboards:
    ...
    def download_detailed_results(include_auth_links: bool = False):
        ...
        # Always show Auth Codes download button for any successful accounts (valid/captcha/2fa)
        keyboard.append([InlineKeyboardButton("🔑 Download Auth Codes", callback_data="download_auth_codes")])
        keyboard.extend([
